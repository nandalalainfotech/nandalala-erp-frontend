...
@Component({
    selector: 'app-budget-varaince-report',
    templateUrl: './budget-varaince-report.component.html',
    styleUrls: ['./budget-varaince-report.component.css'],
})
export class BudgetVarainceReportComponent implements OnInit {
