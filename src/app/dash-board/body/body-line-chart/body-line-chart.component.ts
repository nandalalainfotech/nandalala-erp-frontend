...
@Component({
  selector: 'app-body-line-chart',
  templateUrl: './body-line-chart.component.html',
  styleUrls: ['./body-line-chart.component.css']
})
export class BodyLineChartComponent implements OnInit {
