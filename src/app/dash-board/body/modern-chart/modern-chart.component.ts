...
import {
  ChartComponent, ApexAxisChartSeries, ApexChart, ApexFill, ApexTooltip, ApexXAxis,
  ApexLegend, ApexDataLabels, ApexTitleSubtitle, ApexPlotOptions, ApexYAxis
} from "ng-apexcharts";
// @ts-ignore
import ApexCharts from 'apexcharts';
import { ApexAnnotations, ApexGrid, ApexNonAxisChartSeries, ApexResponsive, ApexStates, ApexStroke, ApexTheme, NgApexchartsModule } from 'ng-apexcharts';

@Component({
  selector: 'app-modern-chart',
  templateUrl: './modern-chart.component.html',
  styleUrls: ['./modern-chart.component.css']
})
export class ModernChartComponent implements OnInit {
  @Input() chart!: ApexChart | undefined;
  @Input() annotations: ApexAnnotations | undefined;
  @Input() colors!: string[];
  @Input() dataLabels: ApexDataLabels | undefined;
  @Input() series: ApexAxisChartSeries | ApexNonAxisChartSeries | undefined;
  @Input() stroke: ApexStroke | undefined;
  @Input() labels!: string[];
  @Input() legend!: ApexLegend;
  @Input() fill: ApexFill | undefined;
  ...
  @Input() grid: ApexGrid | undefined;
  @Input() states: ApexStates | any;
  @Input() title: ApexTitleSubtitle | undefined;
  @Input() subtitle: ApexTitleSubtitle | undefined;
  @Input() theme: ApexTheme | undefined;
...
ngOnInit(){
    ...
    function getNewData(baseval: any, yrange: any) {
